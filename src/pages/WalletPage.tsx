...
export default function WalletPage() {
  ...
  return (
    <div className="w-full flex flex-col gap-4 animate-in fade-in-50 duration-300">
      ...
      <div className="flex items-center gap-1 bg-muted rounded-md p-0.5 border border-border dark:bg-zinc-900 dark:border-zinc-800 overflow-x-auto pb-2 custom-scrollbar">
        {DOMAINS.map((d) => {
          const Icon = d.icon;
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-2.5 py-1 text-xs font-medium rounded-md transition-colors shrink-0 ${
                isActive
            ...
            >
              <Icon className="w-4 h-4" style={{ color: isActive ? "currentColor" : d.color }} />
              {d.label}
            </button>
          );
        })}
                  ...
                  {activeDomain === "income" && (
                    <>
                      ...
                      <td className="p-4 text-center">
                        <span
                          className="px-2 py-0.5 rounded-full text-[9px] font-bold uppercase text-foreground dark:text-zinc-100 border border-border/40 dark:border-zinc-700/40"
                        >
                          {item.status}
                        </span>
                      </td>
